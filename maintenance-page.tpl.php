...
<div class="art-textblock art-object431962460">
...
<?php echo TheCPGroup_Final_SS_art_placeholders_output(render($top1), render($top2), render($top3), 'tops'); ?>
...
<?php echo TheCPGroup_Final_SS_art_content_replace($content); ?>
<?php if ($art_post_position === FALSE): ?>
</div>
...
EOT;
$content = TheCPGroup_Final_SS_art_content_replace($content);
...
<?php if (!empty($banner5)) { echo '<div id="banner5">'.render($banner5).'</div>'; } ?>
            ...
            </div><?php echo TheCPGroup_Final_SS_art_placeholders_output(render($bottom1), render($bottom2), render($bottom3), 'bottoms'); ?>
...
<p style="font-weight: bold; line-height: 22.5px;">Copyright © 2014 The CP Group. All Rights Reserved.<br /></p><p style="font-weight: bold; line-height: 22.5px;">Website Created by&nbsp;<a href="http://www.mcgrathsolutions.org/">McGrath Solutions, Inc.</a></p><p><a href="#"></a></p>
<?php
  $footer = str_replace('%YEAR%', date('Y'), ob_get_clean());
  echo TheCPGroup_Final_SS_art_replace_image_path($footer);
}
?>
